...
export default function PathPolaroid({
  id, who, pen, pin, date, dateLabel,
}: { id: string; who: string; pen?: string | null; pin?: string | null; date: string; dateLabel: string }) {
  ...
  return (
    <figure ref={ref} className="polaroid relative">
      ...
      <figcaption className="reveal-caption py-2 text-center">
        <span className="block text-caption font-semibold text-ink-muted">{who}</span>
